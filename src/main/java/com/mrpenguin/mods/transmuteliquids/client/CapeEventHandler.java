package com.mrpenguin.mods.transmuteliquids.client;
...
public class CapeEventHandler {
	private final String serverLocation = "https://raw.githubusercontent.com/MrPenguin01/Transmute-Liquids/master/capes.txt";
			...
			while((str = br.readLine()) != null) {
				if(!str.startsWith("--")) {
					if(str.contains(":")) {
						...
						System.out.println("[TL] [skins.txt] Syntax error on line " + linetracker + ": " + str);
					}
				}
				linetracker++;
			}
